...
<html lang="en">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="/posts/add">Añadir Posts</a>
      <a class="p-2 text-muted" href="/user/login">Login</a>
      <a class="p-2 text-muted" href="/user/register">Registro</a>
    </nav>
  </div>
